...
COMPONENTS="ccx-data-pipeline ccx-insights-results dvo-writer insights-content-service insights-results-smart-proxy ocp-advisor-frontend ccx-mock-ams ccx-redis" # space-separated list of components to laod
