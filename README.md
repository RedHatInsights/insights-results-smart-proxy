...
[![Build Status](https://ci.ext.devshift.net/buildStatus/icon?job=RedHatInsights-insights-results-smart-proxy-pr-check)](https://ci.ext.devshift.net/job/RedHatInsights-insights-results-smart-proxy-pr-check/)
